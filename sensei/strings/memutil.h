...
#ifndef SENSEI_STRINGS_MEMUTIL_H_
#define SENSEI_STRINGS_MEMUTIL_H_

#include <stddef.h>
#include <string.h>      // to get the POSIX mem*() routines

#include "sensei/base/port.h"   // disable some warnings on Windows
...
#endif  // SENSEI_STRINGS_MEMUTIL_H_
