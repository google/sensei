...
// 2. Scan google3 codebase to identify functions and methods with CharSet
...
#ifndef SENSEI_STRINGS_CHARSET_H_
#define SENSEI_STRINGS_CHARSET_H_
...
#endif  // SENSEI_STRINGS_CHARSET_H_
