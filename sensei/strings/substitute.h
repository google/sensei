...
#ifndef SENSEI_STRINGS_SUBSTITUTE_H_
#define SENSEI_STRINGS_SUBSTITUTE_H_

#include <string.h>
#include <string>
using std::string;

#include "sensei/base/basictypes.h"
...
#if defined(CLANG_BAD_CALL_IF) && defined(LANG_CXX11)
...
#endif  // CLANG_BAD_CALL_IF && LANG_CXX11
...
void SubstituteAndAppend(string* output, const char* format)
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 0,
                      "There were no substitution arguments "
                      "but this format string has a $[0-9] in it");

void SubstituteAndAppend(string* output, const char* format,
                         const substitute_internal::Arg& a0)
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 1,
...
void SubstituteAndAppend(string* output, const char* format,
    ...
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 3,
...
void SubstituteAndAppend(string* output, const char* format,
                         ...
                         const substitute_internal::Arg& a1,
                         const substitute_internal::Arg& a2)
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 7,
...
void SubstituteAndAppend(string* output, const char* format,
    ...
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 15,
...
void SubstituteAndAppend(string* output, const char* format,
                         ...
                         const substitute_internal::Arg& a3,
                         const substitute_internal::Arg& a4)
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 31,
...
void SubstituteAndAppend(string* output, const char* format,
    ...
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 63,
                      "There were 6 substitution arguments given, but "
                      "this format string is either missing its $0-$5, or "
                      "contains one of $6-$9");

void SubstituteAndAppend(
    string* output, const char* format, const substitute_internal::Arg& a0,
    const substitute_internal::Arg& a1, const substitute_internal::Arg& a2,
    const substitute_internal::Arg& a3, const substitute_internal::Arg& a4,
    const substitute_internal::Arg& a5, const substitute_internal::Arg& a6)
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 127,
...
void SubstituteAndAppend(
    ...
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 255,
...
void SubstituteAndAppend(
    ...
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 1023,
                      "There were 10 substitution arguments given, but this "
                      "format string doesn't contain all of $0 through $9");
#endif  // CLANG_BAD_CALL_IF && LANG_CXX11

string Substitute(StringPiece format) MUST_USE_RESULT;
string Substitute(
    StringPiece format,
    const substitute_internal::Arg&) MUST_USE_RESULT;
string Substitute(
    StringPiece format,
    const substitute_internal::Arg&, const substitute_internal::Arg&)
    MUST_USE_RESULT;
string Substitute(
    StringPiece format,
    const substitute_internal::Arg&, const substitute_internal::Arg&,
...
string Substitute(const char* format, const substitute_internal::Arg& a0)
    CLANG_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 1,
                      "There was 1 substitution argument given, but "
                      "this format string is either missing its $0, or "
                      "contains one of $1-$9");
...
#endif  // SENSEI_STRINGS_SUBSTITUTE_H_
