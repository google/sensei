...
#ifndef SENSEI_STRINGS_SPLIT_INTERNAL_H_
#define SENSEI_STRINGS_SPLIT_INTERNAL_H_
...
#include "sensei/base/port.h"  // for LANG_CXX11
#include "sensei/base/template_util.h"
#include "sensei/base/type_traits.h"  // for base::enable_if
...
class ConvertibleToStringPiece {
 ...
 public:
  ...
  // R-value references are currently prohibited in google3. However, austern
...
#endif  // SENSEI_STRINGS_SPLIT_INTERNAL_H_
