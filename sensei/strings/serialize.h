...
#ifndef SENSEI_STRINGS_SERIALIZE_H_
#define SENSEI_STRINGS_SERIALIZE_H_
...
// Convenient form of KeyFromInt64.
inline string Int64ToKey(int64 i64) {
  string s;
  KeyFromInt64(i64, &s);
  return s;
}
...
#endif  // SENSEI_STRINGS_SERIALIZE_H_
