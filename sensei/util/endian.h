...
#ifndef SENSEI_UTIL_ENDIAN_ENDIAN_H_
#define SENSEI_UTIL_ENDIAN_ENDIAN_H_

#include <assert.h>

#include "sensei/base/casts.h"
...
inline uint64 gbswap_64(uint64 host_int) {
#if defined(COMPILER_GCC3) && defined(__x86_64__) && !defined(OS_MACOSX)
...
#endif  // SENSEI_UTIL_ENDIAN_ENDIAN_H_
