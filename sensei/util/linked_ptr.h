...
#ifndef SENSEI_UTIL_GTL_LINKED_PTR_H_
#define SENSEI_UTIL_GTL_LINKED_PTR_H_

#include <stddef.h>

#include "sensei/base/logging.h"  // for CHECK macros
#include "sensei/base/type_traits.h"  // for remove_pointer
...
class linked_ptr {
 public:
  ...
  linked_ptr() { capture(NULL); }
  // Take over ownership of a raw pointer.  This should happen as soon as
  // possible after the object is created.
  explicit linked_ptr(T* ptr) { capture(ptr); }
  ~linked_ptr() { depart(); }
...
#endif  // SENSEI_UTIL_GTL_LINKED_PTR_H_
