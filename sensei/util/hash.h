...
//
#ifndef SENSEI_UTIL_HASH_H_
#define SENSEI_UTIL_HASH_H_
...
template<typename T>
inline uint32 Hash32NumWithSeed(T num, uint32 seed) {
  return Hash32StringWithSeed(reinterpret_cast<const char*>(&num),
                              sizeof(num), seed);
}
...
#define MIX32 hash_internal::kMix32
