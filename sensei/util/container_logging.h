...
#ifndef SENSEI_UTIL_GTL_CONTAINER_LOGGING_H_
#define SENSEI_UTIL_GTL_CONTAINER_LOGGING_H_
...
//   LOG(INFO) << util::gtl::LogEnum(kRed);
template <typename E>
...
#endif  // SENSEI_UTIL_GTL_CONTAINER_LOGGING_H_
