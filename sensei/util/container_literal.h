...
#ifndef SENSEI_UTIL_GTL_CONTAINER_LITERAL_H_
#define SENSEI_UTIL_GTL_CONTAINER_LITERAL_H_
...
// TODO(user): Disallow direct inclusion by clients.
#include "sensei/util/container_literal_generated.h"  // IWYU pragma: export

#endif  // SENSEI_UTIL_GTL_CONTAINER_LITERAL_H_
